# CLAUDE.md — Coding Principles for OTH

These principles guide all work on this project. Claude should follow them without asking for permission or approval.
...
**For Claude specifically:** Execute autonomously using `acceptEdits` permission mode. Make decisions without asking. Document everything in commit messages and end-of-task summaries. Never prompt for approval after the initial request — just build.
